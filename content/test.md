...
<div style="box-sizing:content-style;width:600px;height:100px;background-color:black"></div>

<div style="box-sizing:content-style;width:100%;height:100px;background-color:blue"></div>

<div style="box-sizing:border-box;width:50vw;height:100px;background-color:red"></div>

<!-- <div style="width:100vw;height:100px;background-color:green"></div> -->
